...
|---|---|---|---|
| DRW-002-374 | CRP-150 side drive | Three wheel stations, two idlers, five equal Z50 gears per side, rear long-axle input | CONFIRMED-DRAWING |
| DRW-002-375 / ASS-002-375 | Crawler housing | Two Z40 bevel gears, two 18x30x7 shaft seals, two 61800-2RS 10x19x5 bearings, lift axle components | CONFIRMED-DRAWING |
| DRW-002-386 / ASS-002-386 | Crawler motor unit | Two Z16 bevel gears, two supported pinion shafts, two motor-and-gear units, two 61801-2RS 12x21x5 bearings | CONFIRMED-DRAWING |
| DRW-002-744 | Manual lift parts | Two levers, 150 N gas spring, M8 clamp and spring-stack architecture | CONFIRMED-DRAWING |
| DRW-002-745 | Crawler cover parts | Cover and sealing source family | SOURCE-IDENTIFIED |
| DRW-002-752 | Lift housing | Lift housing source family | SOURCE-IDENTIFIED |
