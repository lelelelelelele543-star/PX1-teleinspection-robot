...
# PX-1 Rev.PS — marketplace-interface crawler master
...
OUT=os.path.abspath('build_revps'); os.makedirs(OUT,exist_ok=True)
...
# ----- exports -----
cq.exporters.export(body,os.path.join(OUT,'PX1_CRP150_PressureBody_RevPS.step'))
assy=cq.Assembly(name='PX1_CRP150_MarketplaceMaster_RevPS')
...
assy.save(os.path.join(OUT,'PX1_CRP150_MarketplaceMaster_RevPS.step'))
with open(os.path.join(OUT,'REV_PS_VALIDATION.json'),'w') as f: json.dump(checks,f,indent=2)
